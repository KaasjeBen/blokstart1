<nav x-data="{ open: false }" class="border-b border-[#d8d1c4] bg-[#fbfaf7] dark:border-[#303949] dark:bg-[#1a2130]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <a href="{{ Auth::check() ? route('dashboard') : route('login') }}">
                        <x-application-logo class="block h-9 w-auto fill-current text-[#172033] dark:text-[#e9e5dc]" />
                    </a>
                </div>
